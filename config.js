...
const CONFIG = {
  ...
  // ----------------------------------------------------------
  PORTFOLIO_URL: "https://vibrantwinessg.github.io/Tradelist-Vibrant/",
  ...
  // (This is the Trade version: $400 free-delivery threshold, $20
  // fee below it — the Retail version uses $425 / $25 instead.)
  // ----------------------------------------------------------
  ...
  PRICE_LABEL_SUFFIX: " (ex GST)",    // appended after every "Total" label — Trade version only (Retail leaves this "")
};
